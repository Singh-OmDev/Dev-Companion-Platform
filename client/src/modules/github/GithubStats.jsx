...
const GithubStats = () => {
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center p-8 bg-black/20 rounded-xl border border-red-500/30 text-center animate-fade-in max-w-2xl mx-auto mt-12">
