...
import { Layers, Terminal, Cpu, Database, ArrowRight } from 'lucide-react';
...
const FeatureBlock = ({ number, title, subtitle, description }) => {
    return (
        <div className="w-full flex flex-col md:flex-row items-start justify-between py-24 border-t border-white/10 group">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6">
                ...
                <RevealText delay={0.2}>
                    <p className="text-lg md:text-xl text-[#A0A0A0] font-light leading-relaxed max-w-lg">
                        {description}
                    </p>
                </RevealText>
                <RevealText delay={0.3}>
                    <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-colors duration-500 mt-4 cursor-crosshair">
    ...
    return (
        <div className="bg-[#020202] text-[#EBEBEB] font-sans selection:bg-[#D4F23F] selection:text-black overflow-x-hidden w-full relative">
            ...
            <div className="fixed top-8 left-8 z-[100] pointer-events-none hidden md:block mix-blend-difference">
                ...
                <p className="text-[10px] font-mono font-bold tracking-[0.2em] text-[#A0A0A0] uppercase mt-2">v2.4.0-beta</p>
            </div>
            ...
            <div className="fixed top-1/2 right-8 -translate-y-1/2 z-[100] pointer-events-none hidden lg:block mix-blend-difference" style={{ writingMode: 'vertical-rl' }}>
                <p className="text-[10px] font-mono font-bold tracking-[0.2em] text-[#A0A0A0] uppercase">
                    Build: Passing // Latency: 12ms // Protocol: Active
                </p>
            </div>
            ...
            <footer className="fixed bottom-0 inset-x-0 w-full z-[100] px-8 py-6 flex items-end justify-between pointer-events-none mix-blend-difference">
                <div className="hidden md:flex flex-col gap-1 pointer-events-auto cursor-help group">
                    <p className="font-mono text-[10px] uppercase font-bold tracking-[0.2em] text-[#A0A0A0] flex items-center gap-2">
                        ...
                        Connections: 4 (Stable)
                    </p>
                    <p className="font-mono text-[10px] uppercase opacity-0 group-hover:opacity-100 transition-opacity text-[#666]">
                        GITHUB • LEETCODE • CLERK • DB
                    </p>
                </div>
                <div className="text-right pointer-events-auto mr-0 lg:mr-10">
                    <a href="#" className="font-mono text-[10px] uppercase font-bold tracking-[0.2em] text-[#A0A0A0] hover:text-[#D4F23F] transition-colors border-b border-white/20 hover:border-[#D4F23F] pb-1">
                        View Documentation
                    </a>
                </div>
            </footer>
            ...
            <nav className="fixed top-8 inset-x-0 w-full z-[100] px-8 mx-auto flex items-start justify-between mix-blend-difference pointer-events-none">
                <div className="w-1/3 pt-12 md:pl-24 hidden md:block pointer-events-auto">
                    <button onClick={scrollToFeatures} className="text-xs font-bold tracking-widest uppercase hover:blur-[2px] hover:text-white text-[#A0A0A0] cursor-crosshair transition-all">Explore Modules</button>
                </div>
                ...
                <div className="w-full md:w-1/3 flex justify-end gap-6 md:pr-12 pt-12 pointer-events-auto">
                    <SignInButton mode="modal">
                        <button className="text-xs font-bold tracking-[0.1em] uppercase text-[#A0A0A0] hover:text-[#D4F23F] hover:tracking-[0.2em] transition-all duration-300">
                            SignIn
                        </button>
                    </SignInButton>
                    <SignUpButton mode="modal">
                        <button className="text-xs font-bold tracking-[0.1em] uppercase text-black bg-white hover:bg-[#D4F23F] px-4 py-1 flex items-center gap-2 transition-all duration-300 shadow-[4px_4px_0_rgba(255,255,255,0.2)] hover:-translate-y-1 hover:shadow-[4px_8px_0_rgba(212,242,63,0.3)] border border-transparent">
                            Initialize
                        </button>
                    </SignUpButton>
                </div>
            ...
            <div className="relative z-10 w-full">
                ...
                <section className="w-full h-screen relative flex flex-col justify-center overflow-hidden">
                    ...
                    >
                        <motion.h1
                            ...
                            className="text-[16vw] sm:text-[18vw] font-black tracking-tighter leading-[0.8] text-white uppercase text-center mix-blend-difference w-full"
                        >
                            DEV
                        </motion.h1>
                        <motion.h1
                            ...
                            className="text-[16vw] sm:text-[18vw] font-black tracking-widest leading-[0.8] text-white uppercase text-center mix-blend-difference w-full ml-[6vw]"
                        >
                        ...
                        >
                            ...
                            <span className="animate-bounce inline-block mt-4 opacity-50">↓ SCROLL TO EXPLORE</span>
                        </motion.div>
                    </motion.div>
                ...
                <section id="features" className="w-full max-w-[90vw] lg:max-w-[75vw] mx-auto py-32 relative z-30 bg-[#020202]">
                    <div className="mb-32">
                        <RevealText>
                            <h2 className="text-[10vw] md:text-[8vw] font-black tracking-tighter uppercase leading-[0.8] mb-8">
                    ...
                    <div className="w-full py-32 flex flex-col items-center justify-center text-center">
                        <RevealText>
                            <h2 className="text-[12vw] font-black tracking-tighter uppercase leading-[0.8] mb-12 hover:text-[#D4F23F] transition-colors duration-500 cursor-crosshair">
                                INITIATE
                            </h2>
                        </RevealText>
                        <RevealText delay={0.2}>
                            <SignUpButton mode="modal">
                                <button className="text-xl md:text-2xl font-black uppercase bg-white text-black px-12 py-6 flex items-center gap-4 transition-all hover:bg-[#D4F23F] group">
                                    Create Profile
